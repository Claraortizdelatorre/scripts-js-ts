/*función que reciba una lista de estudiantes (que tienen nombre y una lista de notas) 
...
No se permite el uso de clases. En caso de usar funciones auxiliares típalas. Puedes usar la función 
Number.prototype.toPrecision(3) para reducir el número de decimales de la media de calificaciones a tres números.*/
